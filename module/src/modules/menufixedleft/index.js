...
class menufixedleft extends Component {
    ...
    constructor(props) {
        ...
        this.type = 'MenuFixedLeft';
        this.defaultClass = 'react-divcreator-menu-fixed-left';
        this.defaultClassMounted = 'react-divcreator-menu-fixed-left-mounted mounted';
        this.requiredProps = {};
        this.state = {
            mounted: false,
            dimmed: props.dimmed ? props.dimmed : false,
    ...
    userCallback(e) {
        ...
        if (this.state.animation && contentNode) {
            ...
            const animationClass = 'scale' == this.state.animationType ? `${this.defaultClass}__content--animation-back` : `${this.defaultClass}__content--animation--width-back`;
    ...
    render() {
        ...
        const animationClass = 'scale' == this.state.animationType ? `${this.defaultClass}__content--animation` : `${this.defaultClass}__content--animation--width`;
