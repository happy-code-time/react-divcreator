...
class menufixedbottom extends Component {
    ...
    constructor(props) {
        ...
        this.type = 'MenuFixedBottom';
        this.defaultClass = 'react-divcreator-menu-fixed-bottom';
        this.defaultClassMounted = 'react-divcreator-menu-fixed-bottom-mounted mounted';
        this.requiredProps = {};
        this.state = {
            mounted: false,
...
export default menufixedbottom;
