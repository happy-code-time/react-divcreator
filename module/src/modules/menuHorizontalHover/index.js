...
class menuHorizontalHover extends Component {

    constructor(props) {
        super(props);
        this.type = 'MenuHorizontalHover';
    ...
    render() {
        ...
        if (true == checkProps.keysAvailable && false == checkProps.type) {
             ...
             * Return modules html
             */
            let masterClass = `${this.defaultClass} ${rootClass} react-divcreator-menu-1-horizontal ${this.state.mounted ? this.defaultClassMounted : 'before-mount'}`;
            ...
            if (menu_data.length) {
                ...
                for (let a = 0; a <= etage1.length - 1; a++) {
                    let child2 = etage1[a];
                    let customClassForRootMarked = `react-divcreator-menu-1-li-horizontal-${a}`;
                    ...
                    if (child2.data && child2.data.length) {
                        ...
                        for (let b = 0; b <= child2.data.length - 1; b++) {
                            ...
                            if (child3.data && child3.data.length) {
                                    ...
                                    if (child4.data && child4.data.length) {
                                        ...
                                        for (let d = 0; d <= child4.data.length - 1; d++) {
                                            ...
                                            if (child5.data && child5.data.length) {
                                                    ...
                                                    if (child6.data && child6.data.length) {
                                                        for (let e = 0; e <= child6.data.length - 1; e++) {
                                                            ...
                                                            if (this.props.link) {
                                                                ...
                                                                etageMenu6.push(
                                                                    <li key={customKey()} onClick={event => this.markAsClicked(customClassForRootMarked)} className={`react-divcreator-menu-6-li-horizontal`}>
                                                        ...
                                                        if (this.props.link) {
                                                            etageMenu5.push(
                                                                <li key={customKey()} onClick={event => this.markAsClicked(customClassForRootMarked)} className={`react-divcreator-menu-5-li-horizontal`}>
                                                                    ...
                                                                    {
                                                                        etageMenu6 &&
                                                                        <ol className={`react-divcreator-menu-6-horizontal`}>
                                                                            {etageMenu6}
                                                                        </ol>
                                                                    }
                                                                </li>
                                                ...
                                                if (this.props.link) {
                                                    etageMenu4.push(
                                                        <li key={customKey()} onClick={event => this.markAsClicked(customClassForRootMarked)} className={`react-divcreator-menu-4-li-horizontal`}>
                                                            ...
                                                            {
                                                                etageMenu5 &&
                                                                <ul className={`react-divcreator-menu-5-horizontal`}>
                                                                    {etageMenu5}
                                                                </ul>
                                                            }
                                                        </li>
                                        ...
                                        if (this.props.link) {
                                            etageMenu3.push(
                                                <li key={customKey()} onClick={event => this.markAsClicked(customClassForRootMarked)} className={`react-divcreator-menu-3-li-horizontal`}>
                                                    ...
                                                    {
                                                        etageMenu4 &&
                                                        <ol className={`react-divcreator-menu-4-horizontal`}>
                                                            {etageMenu4}
                                                        </ol>
                                                    }
                                                </li>
                                ...
                                if (this.props.link) {
                                    etageMenu2.push(
                                        <li key={customKey()} onClick={event => this.markAsClicked(customClassForRootMarked)} className={`react-divcreator-menu-2-li-horizontal`}>
                                            ...
                                            {
                                                etageMenu3 &&
                                                <ul className={`react-divcreator-menu-3-horizontal`}>
                                                    {etageMenu3}
                                                </ul>
                                            }
                                        </li>
                        ...
                        if (this.props.link) {
                            etageMenu1.push(
                                <li key={customKey()} onClick={event => this.markAsClicked(customClassForRootMarked)} className={`react-divcreator-menu-1-li-horizontal ${customClassForRootMarked}`}>
                                    ...
                                    {
                                        etageMenu2 &&
                                        <ol className={`react-divcreator-menu-2-horizontal`}>
                                            {etageMenu2}
                                        </ol>
                                    }
                                </li>
...
export default menuHorizontalHover;
