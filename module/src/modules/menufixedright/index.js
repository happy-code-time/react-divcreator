...
class menufixedright extends Component {
    ...
    constructor(props) {
        ...
        this.type = 'MenuFixedRight';
        this.defaultClass = 'react-divcreator-menu-fixed-right';
        this.defaultClassMounted = 'react-divcreator-menu-fixed-right-mounted mounted';
        this.requiredProps = {};
        this.state = {
            mounted: false,
