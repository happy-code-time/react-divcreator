...
class menuanimationcustom extends Component {
    ...
    constructor(props) {
        ...
        this.animateMenuCustom = this.animateMenuCustom.bind(this);

        this.type = 'MenuAnimationCutom';
        this.defaultClass = `react-divcreator-menuanimation-custom`;
        this.defaultClassMounted = 'react-divcreator-menuanimation-custom-mounted mounted';
        this.requiredProps = {
            useLink: 'boolean'
        };
        this.state = {
            ...
            debugging: true,
            mounted: false,
            overlap: this.props.overlap ? this.props.overlap : false
        };
    ...
    animateMenuCustom() {
        if (this.state.isAnimated) {
            this.setState({
                customAnimated: 'react-divcreator-menuanimation-icons--custom__animated'
            })
        } else {
            this.setState({
                customAnimated: ''
    ...
    render() {
        ...
        if(this.state.overlap){
            holderParentStyle.top = '0px';
            holderParentStyle.zIndex = 1;
            custom.zIndex = (this.state.customAnimated.length && this.state.includeContent) ? -1 : 1;
        }
        ...
        return (
            ...
            >
                {
                    'custom' == this.state.type && this.props.typeCustomData &&
                    <div 
                        className={`react-divcreator-menuanimation-icons--custom ${this.state.customAnimated} ${this.state.border ? 'border' : ''}`} 
                        onClick={(e) => this.animateMenu(e, 'custom')}
                        style={custom}
                    >
                        {
                            this.props.typeCustomData
                        }
                    </div>
                }
                {
                    this.state.isAnimated && this.state.includeContent &&
                    <span className="react-divcreator-menuanimation-holder--span" style={holderParentStyle}>
...
export default menuanimationcustom;
